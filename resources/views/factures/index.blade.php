        ...
        <tr class="border-t border-gray-100 hover:bg-blue-50 transition">
            ...
            <td class="p-3 text-center">
                <div class="flex flex-col md:flex-row gap-2 justify-center items-center">
                    ...
                    <a href="{{ route('factures.download', $facture->id) }}" class="inline-flex items-center gap-1 px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 font-medium shadow transition" title="Télécharger PDF">
                        📄 PDF
                    </a>
